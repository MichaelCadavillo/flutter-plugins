...
Future<void> main() async {
  ...
  const bool skipDueToIssue86757 = true;
  ...
  }, skip: Platform.isAndroid && skipDueToIssue86757);
...
class ResizableWebView extends StatefulWidget {
  const ResizableWebView(
      {Key? key, required this.onResize, required this.onPageFinished}) : super(key: key);
